...
class Institution(models.Model):  # Cambié el nombre de la clase a singular
    ...
    subscription_date = models.DateField(default=timezone.now, blank=False)  # Cambié a DateField
    suscription_type = models.CharField(max_length=50, blank=False, default='none')
